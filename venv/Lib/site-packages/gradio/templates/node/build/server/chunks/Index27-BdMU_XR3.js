import { B as Block, S as Static, P as BlockTitle, h as Empty, ap as LineChart, aj as globals } from './2-EMQCJWdp.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-BASuEjBR.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index27-BdMU_XR3.js.map
