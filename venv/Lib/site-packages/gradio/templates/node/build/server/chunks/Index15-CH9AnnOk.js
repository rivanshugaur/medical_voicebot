...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-EMQCJWdp.js';
...
const lang_map = {
  python: () => import('./index32-uKADHl78.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-D56CBWdF.js'),
      import('./frontmatter-BbrxZvBJ.js')
    ]);
  ...
  json: () => import('./index37-DSX1iBwK.js').then((m) => m.json()),
  html: () => import('./index34-D55wgckJ.js').then((m) => m.html()),
  css: () => import('./index35-DG0oAuBr.js').then((m) => m.css()),
  javascript: () => import('./index36-C46CmUk5.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-C46CmUk5.js').then(
...
//# sourceMappingURL=Index15-CH9AnnOk.js.map
